<div>
    <div class="flex flex-col lg:flex-row justify-end items-center gap-3 mb-3">
    ...
    <div class="mt-3">
        <div id="segment-1" role="tabpanel" aria-labelledby="segment-item-1">
            <div class="flex">
                <div class="border-e border-gray-200 dark:border-neutral-700 bg-[#4071f4] rounded-xl">
            ...
            <div class="overflow-x-auto">
                ...
                <table class="min-w-full border border-gray-300 text-sm">
                    <thead class="bg-gray-100">
                        <tr>
                            <th class="px-4 py-2 border dark:text-black text-xs">Time</th>
                            <th class="px-4 py-2 border dark:text-black text-xs">Temp (°C)</th>
                            <th class="px-4 py-2 border dark:text-black text-xs">Humidity (%)</th>
                            <th class="px-4 py-2 border dark:text-black text-xs">Liquid Temp (°C)</th>
                            <th class="px-4 py-2 border dark:text-black text-xs">Alcohol Level (%)</th>
                            <th class="px-4 py-2 border dark:text-black text-xs">Sugar (°Brix)</th>
                            <th class="px-4 py-2 border dark:text-black text-xs">pH Level</th>
                            <th class="px-4 py-2 border dark:text-black text-xs">Liquid Level (%)</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($temperatureData as $index => $row)
                            <tr>
                                {{-- <td class="px-4 py-2 border text-center">{{ $row['Value'] }}</td> --}}
                                <td class="px-4 py-2 border text-center text-xs">{{ $row['time'] }}</td>
                                <td class="px-4 py-2 border text-center text-xs">{{ $temperatureData[$index]['Value'] ?? '-' }}</td>
                                <td class="px-4 py-2 border text-center text-xs">{{ $humidityData[$index]['Value'] ?? '-' }}</td>
                                <td class="px-4 py-2 border text-center text-xs">{{ $liquidTempData[$index]['Value'] ?? '-' }}</td>
                                <td class="px-4 py-2 border text-center text-xs">{{ $alcoholData[$index]['Value'] ?? '-' }}</td>
                                <td class="px-4 py-2 border text-center text-xs">{{ $brixData[$index]['Value'] ?? '-' }}</td>
                                <td class="px-4 py-2 border text-center text-xs">{{ $pHLevelData[$index]['Value'] ?? '-' }}</td>
                                <td class="px-4 py-2 border text-center text-xs">{{ $liquidLevelData[$index]['Value'] ?? '-' }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>

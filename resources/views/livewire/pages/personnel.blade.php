<div>
    <div class="w-full flex justify-end items-center mb-3">
        <x-button 
            icon="plus-sm" 
            positive label="Add Operator" 
            onclick="$openModal('newPersonnel')"
            class="bg-[#06402a] text-white hover:bg-[#052d20] hover:ring-2 hover:ring-[#06402a] hover:ring-offset-2 hover:ring-offset-white dark:hover:ring-offset-neutral-800 dark:hover:bg-neutral-700 dark:hover:text-neutral-300" 
        />
    </div>
        ...
        <div class="-m-1.5 overflow-x-auto">
            <div class="p-1.5 min-w-full inline-block align-middle">
                <div>
                    ...
                    @else
                        <table class="w-full border-separate border-spacing-y-4 divide-gray-200 dark:divide-neutral-700">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                @foreach ($personnelLists as $personnel)
                                    <tr class="odd:bg-white even:bg-gray-100 hover:bg-gray-100 dark:odd:bg-neutral-800 dark:even:bg-neutral-700 dark:hover:bg-neutral-700">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200 rounded-l-full shadow-sm">
                                            {{-- personnel-?name --}}
                                            {{ $personnel->name }}
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium rounded-r-full shadow-sm">
                                            <div class="flex gap-2">
                                                @if ($personnel->email === 'lambag@gmail.com')
    ...
    <x-modal blur name="newPersonnel" persistent align="center" max-width="sm">
        <form wire:submit.prevent="createNewPersonnel" class="w-full">
            <x-card title="Create New Operator">
